...
export default function Header() {
    return (
        <div className="flex sticky top-0 z-50 px-4 md:px-0 h-20 flex items-center">
            <div className="md:max-w-md w-full md:mx-auto rounded-full border border-slate-200 flex items-center px-4 py-3 h-fit bg-white/80 backdrop-blur-md shadow-sm">
